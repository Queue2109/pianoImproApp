...
public class MidiInstrumentChecker
{
    ...
    private static Dictionary<int, int> GetProgramChanges(MidiFile midiFile)
    {
        ...
        foreach (var trackChunk in midiFile.GetTrackChunks())
        {
            ...
            {
                if (midiEvent is ProgramChangeEvent programChangeEvent)
                {
                    int channel = programChangeEvent.Channel;
                    int programNumber = programChangeEvent.ProgramNumber;
    ...
    private static string GetInstrumentName(int programNumber)
    {
        ...
        return (programNumber >= 0 && programNumber < instruments.Length) ? instruments[programNumber] : "Unknown";
    }

    private static bool IsPianoInstrument(int programNumber)
    {
        return programNumber >= 0 && programNumber <= 7; // Program numbers for piano instruments in General MIDI
    }
}
